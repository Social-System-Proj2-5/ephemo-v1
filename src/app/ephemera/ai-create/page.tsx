      ...
      <div className="mx-auto max-w-6xl">
        <header className="mb-8 flex items-center justify-between gap-3 border-b border-stone-300 pb-4">
          ...
          <div className="flex shrink-0 items-center gap-3">
            {pointsBalance !== null && (
              <p className="text-right text-xs font-medium text-stone-600 sm:text-sm">
                Points: {pointsBalance}
              </p>
            )}
            <Link
              href="/"
              className="w-fit shrink-0 rounded-md border border-stone-300 bg-white px-4 py-2 text-sm font-medium transition hover:bg-stone-100"
            >
              ホーム
            </Link>
          </div>
